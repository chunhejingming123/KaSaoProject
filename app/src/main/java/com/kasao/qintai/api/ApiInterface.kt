...
class ApiInterface {
    companion object {
        ...
        // 提交预订单信息
        var SUBMIT_ONLINE_BUY = "Api/CarsubscribeApi/setCarsubscribe?type=2"
        // 汽贸品牌列表
        ...
        // 预订单列表
        var ORDER_LIST = "Api/CarsubscribeApi/getCarsubscribeitem?type=2"
        //意见反馈
        val OPINION = "Api/PublicApi/feedBackApi"
        //汽贸朋友圈
        val CAR__FRIENDSQUAN = "Api/CarAircleApi/getAircleList?type=2"
        //修改个人信息
        val MODEIFYMY = "Api/UserApi/updateUserApi?type=2"
        // 获取用户信息接口
        val USERINFO = "Api/UserApi/getUserInfoApi?type=2"
        // 汽贸圈点赞
        val CAR_ZAN = "Api/CarAircleApi/clickAircleLikes?type=2"
        //举报
        var REPORTMSG = "Api/AircleApi/clickAircleReport?type=2"
        //获取举报信息
        var GETREPORTMSG = "Api/AircleApi/getAricleReportinfo"
        // 删除汽贸圈
        val DELETE_CAR_CICLE = "Api/CarAircleApi/delAircle"
        val CAR_BROWAWCOUNT = "Api/CarAircleApi/postAirclebrower?type=2"
        // 获取汽贸圈评论点赞接口
        val CAR_COMMENT_LIKE = "Api/CarAircleApi/getNewAritcleinfo?type=2"
        //汽贸圈发评论
        val CAR_SETFRIENDSPINGLUN = "Api/CarAircleApi/clickAircleReview?type=2"
        //汽贸圈回复接口
        val CAR_FRIEMDREPLEY = "Api/CarAircleApi/postarticlereply?type=2"
        //删除汽贸圈自己的评论
        var DELETE_CAR_ONECOMMENT = "Api/CarAircleApi/delAircleReview"
        //汽贸圈浏览记录
        val CAR_LOOKCOUNT = "Api/CarAircleApi/getbrowselist?type=2"
        //获取汽贸圈点赞列表
        val CAR_ZANS = "Api/CarAircleApi/getLikesList?type=2"
        //获取短信验证码
        var VERIFICATIONCODE = "Api/SmsApi/sendSms"
        // 验证码登录
        var VERIFICATLOGIN = "Api/SmsApi/kscheckSms"
        //登录
        ...
        //发布朋友圈
        val FABUFRIENDS = "Api/AircleApi/addAircleList?type=2"
        //版本更新
        val UPVERSION = "Api/Common/updateksEdition?type=2"
        //汽车收藏列表
        var CAR_SHORE_LIST = "Api/CarshopApi/getCarFavorite?type=2"
        //询底价 留下用户信息
        val leavePhone = "Api/CarshopApi/setCarconsult?type=2"
        // 收藏 汽车
        val CAR_STORE = "Api/CarshopApi/setCarFavorite?type=2"
        //我的补贴金
        val My_bullter="Api/LogisticsApi/getCarbutie?type=2"
        // 卡车活动
        var CAR_ACTIVITE = "Api/PublicApi/deadlinetime"
