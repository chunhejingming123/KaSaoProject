...
public class DialogeInvitedSucess implements View.OnClickListener {
    private Dialog mDialoge;
    private SoftReference<Activity> soft = null;
    private View mView;

    public DialogeInvitedSucess(Activity mActivity) {
    ...
    private void initView() {
        View view = LayoutInflater.from(soft.get()).inflate(R.layout.dialoge_action_invitedsucess, null);
        mDialoge.setContentView(view);
        mView = view.findViewById(R.id.btnClose);
