...
public class DialogeDelDynamic implements View.OnClickListener {
    private Dialog mDialoge;
    private SoftReference<Activity> soft = null;

    public DialogeDelDynamic(Activity mActivity) {
    ...
    private void initView() {
        View view = LayoutInflater.from(soft.get()).inflate(R.layout.dialoge_del_dynamic, null);
