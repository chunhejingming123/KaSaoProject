    ...
    private void fillValue(int position, ViewHolder viewHolder) {
        ...
        if (checkItemPosition != -1) {
            if (checkItemPosition == position) {
                viewHolder.mText.setTextColor(context.getResources().getColor(R.color.color_ee2e3b));
                actionSelect(viewHolder.mText);
            } else {
                viewHolder.mText.setTextColor(context.getResources().getColor(R.color.color_333333));
