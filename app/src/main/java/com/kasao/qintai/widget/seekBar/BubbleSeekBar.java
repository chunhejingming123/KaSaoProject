package com.kasao.qintai.widget.seekBar;
...
import static com.kasao.qintai.widget.seekBar.BubbleUtils.dp2px;
import static com.kasao.qintai.widget.seekBar.BubbleUtils.sp2px;
...
public class BubbleSeekBar extends View {
    ...
    public BubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mapCircle= FileUtils.readBitMap(getContext(),R.drawable.icon_seekbar_guide);
        mapLine=FileUtils.readBitMap(getContext(),R.drawable.icon_seekbar_line);
        mapLine=zoomImg(mapLine, ScreenUtil.getScreenW()-getResources().getDimensionPixelOffset(R.dimen.dimen_30),mapLine.getHeight());
...
//        }
      ...
      // canvas.drawCircle(mThumbCenterX, yTop, isThumbOnDragging ? mThumbRadiusOnDragging : mThumbRadius, mCirclePaint);
//        canvas.drawCircle(mThumbCenterX, yTop, isThumbOnDragging ? mThumbRadius:mThumbRadius, mCirclePaint);
//       canvas.drawCircle(mThumbCenterX, yTop, isThumbOnDragging ? mThumbRadius/2 : mThumbRadius/2, mPaint);
        canvas.drawBitmap(mapLine,0,yTop-mapLine.getHeight()/2,mPaint);
        canvas.drawBitmap(mapCircle,mThumbCenterX-(mapCircle.getWidth()/2),yTop-(mapCircle.getHeight()/2)+ ContextComp.getDimension(R.dimen.dimen_2),mCirclePaint);
